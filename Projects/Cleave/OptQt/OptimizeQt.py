...
from OptQt.QTyping import WidgetOrLayoutDict, TabWidgetDict
...
# 此代码借鉴于 https://github.com/PyQt5/PyQt/blob/master/QProgressBar/RoundProgressBar.py
class CircleProgressBar(AbstractWidget):
    ...
    @pyqtProperty(QColor)
    def color(self) -> QColor: return self.Color
    ...
    @pyqtProperty(bool)
    def clockwise(self) -> bool: return self.Clockwise
    ...
    @pyqtProperty(int)
    def delta(self) -> int: return self.Delta
    ...
    def setWidgets(self,
                   initialColor : QColor = QColor(0, 255, 0),
                   delta : int = 32,
                   clockwise : bool = True,
                   angle : int = 0,
                   **kwargs) -> 'CircleProgressBar':
        self.color = initialColor
        self.delta = delta
        self.clockwise = clockwise
        self.angle = angle
        return self.factoryConstructor(**kwargs)

class OptListWidget(QListWidget, AbstractWidget):
    def setWidgets(self,
                   items : Optional[Union[List[QListWidgetItem], List[str]]] = None,
                   align : Qt.Alignment = Qt.AlignLeft,
                   **kwargs):
        self.baseCfg(**kwargs)
        self.setItemAlignment(align)
        return self.readdItems(items)

    def readdItems(self, items : Union[List[QListWidgetItem], List[str]]):
...
class OptListWidgetItem(QListWidgetItem):
    def setWidgets(self,
                   text : Optional[str] = None,
                   icon : Optional[Union[str, QIcon]] = None,
                   background_color : QColor | QBrush | QGradient = QColor(240, 240, 240),
                   foreground_color : QColor | QBrush | QGradient = QColor(0, 0, 0),
                   tips : Optional[str] = None,
                   selectable : bool = True,
                   align : Qt.Alignment | int | None = None,
                   flags : Optional[Qt.ItemFlags] = None,
                   checkState : Optional[Qt.CheckState] = None
                   ):
        self.setForeground(foreground_color)
        self.setBackground(background_color)
